...
const WELCOME = {
  id:   'welcome',
  role: 'bot',
  text: "Hi! I'm NeuralPath's AI assistant 🤖\n\nAsk me about programs, pricing, mentors, or anything career-related!",
}
...
export default function Chatbot({ session }) {
  ...
  async function sendMessage(text) {
    ...
    try {
      ...
      const botBubble = { id: Date.now() + 1, role: 'bot', text: res.reply || 'Let me look into that for you!' }
      setMessages(prev => [...prev, botBubble])
    } catch {
      setMessages(prev => [...prev, {
        id:   Date.now() + 1,
        role: 'bot',
        text: 'Sorry, I\'m having trouble connecting. Please try again or email us at support@neuralpath.ai',
      }])
    } finally {
      setLoading(false)
    }
        ...
        {open && (
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-white/10 flex-shrink-0">
              ...
              <div>
                <div className="text-sm font-semibold">NeuralPath AI</div>
